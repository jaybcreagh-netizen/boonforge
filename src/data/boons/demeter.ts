...
const DEMETER_CORE: Boon[] = [
  ...
  { id: 'arctic-gale', augments: 'cast', gods: ['demeter'], name: 'Arctic Gale', type: 'core', slot: 'none', element: 'water', description: 'Your Casts also create a Gust at the binding circle dealing 4 damage every 0.25 sec.', requires: [] },
