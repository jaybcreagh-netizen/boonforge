...
const ARES_CORE: Boon[] = [
  ...
  { id: 'cut-above', gods: ['ares'], name: 'Cut Above', type: 'core', slot: 'none', element: 'earth', description: 'Your Omega Moves also drop a falling blade over each struck foe, dealing 90 damage, costing +5 Magick.', requires: [] },
