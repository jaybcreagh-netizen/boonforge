...
export const ARTEMIS_BOONS: Boon[] = [
  { id: 'support-fire', gods: ['artemis'], name: 'Support Fire', type: 'core', slot: 'none', element: 'air', description: 'After you hit with your Attacks or Specials, fire a seeking arrow dealing 10 damage.', requires: [] },
  ...
  { id: 'easy-shot', gods: ['artemis'], name: 'Easy Shot', type: 'core', slot: 'none', element: 'air', description: 'A piercing arrow dealing 50 damage fires toward any foe damaged by your Omega Cast.', requires: [] },
