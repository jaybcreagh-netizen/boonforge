...
const HESTIA_CORE: Boon[] = [
  ...
  { id: 'controlled-burn', augments: 'special', gods: ['hestia'], name: 'Controlled Burn', type: 'core', slot: 'none', element: 'fire', description: 'Your Omega Special also launches a fireball dealing 100 blast damage, costing +10 Magick.', requires: [] },
