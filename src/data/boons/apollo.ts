...
const APOLLO_CORE: Boon[] = [
  ...
  { id: 'prominence-flare', augments: 'cast', gods: ['apollo'], name: 'Prominence Flare', type: 'core', slot: 'none', element: 'fire', description: 'After your Omega Cast expires, rapidly deal 10 damage in the area for 2 sec.', requires: [['solar-ring']] },
