...
export const DIONYSUS_BOONS: Boon[] = [
  ...
  { id: 'drunken-stupor', augments: 'omega', gods: ['dionysus'], name: 'Drunken Stupor', type: 'core', slot: 'none', element: 'water', description: 'Your Omega Moves inflict Hangover damage-over-time the first time they strike each foe.', requires: [] },
